 ...
 */
class HTMLMultiButtonResponse implements JsPsychPlugin<Info> {
  static info = info;
  ...
  trial(display_element: HTMLElement, trial: TrialType<Info>) {
    ...
    if (trial.stimulus_duration !== null) {
        ...
        (display_element.querySelector('#jspsych-html-multi-button-response-stimulus') as HTMLElement).style.visibility = 'hidden';        }, trial.stimulus_duration);
    }
...
export default HTMLMultiButtonResponse;
